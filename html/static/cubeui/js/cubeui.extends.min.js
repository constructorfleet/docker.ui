        ...
        a.fn.daterangebox = function(c, d) {
            ...
            a.fn.daterangebox.defaults = a.extend({}, a.fn.textbox.defaults, {
                ...
                locale: {
                    ...
                    fromLabel: '起始Time',
                    toLabel: 'EndTime',
                    customRangeLabel: '自Definitions',
                    weekLabel: "周",
                    firstDay: 1,
                    daysOfWeek: ['日', '一', '二', '三', '四', '五', '六'],
                    monthNames: ['January', 'February', 'March', 'April', 'May', 'June',
                        'July', 'August', 'September', 'October', '十January', '十February'],
                },
                ranges: {

                    //'Recent1Hours': [moment().subtract('hours',1), moment()],
                    'Today': [moment(), moment()],
                    'Yesterday': [moment().subtract(1, 'days').startOf('day'), moment().subtract(1, 'days').endOf('day')],
                    'Recent7日': [moment().subtract(6,'days'), moment()],
                    'Recent30日': [moment().subtract(29, 'days'), moment()],
                    'This month': [moment().startOf("month"), moment().endOf("month")],
                    'Last month': [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")]
                },
                opens: 'right',    // DateSelection框的弹出Location
                alwaysShowCalendars: true,
                timePicker: false,
                timePicker24Hour: true,
                timePickerSeconds: true,
                showWeekNumbers: true,     // Whether or notShow第几周
            ...
            this.each(function() {
                ...
                if(b.url){
                    ...
                    a.ajax({
                        ...
                        error: function(b) {
                            $.app.showerror('AccessChartDataFailed!');
                            e.hideLoading()
                        }
                    });
    ...
    function(a){
        ...
        a.fn.iUploadbox = function(b, c) {
            ...
            this.each(function() {
                ...
                0 == a("#" + b.id + "-btn").length && (a(this).closest("form").append('<button type="button" class="layui-btn" id="' + b.id + '-btn" style="display: none;">UploadPicture</button>'),
 ...
 *
 * Extensiondatagrid，Add动态Increase或DeleteEditor的Methodology
 *
 * Here are some examples，第二个ParametersIt could beArray
 *
 ...
 * 动态ChangeEdit器
 * Usage：
 * ChangeEdit器 dg.datagrid("changeEditor",{index:0,field :'name',editor:'textbox'})
 * dg.datagrid("changeEditor",{index:0,field :'name',editor:{type:'textbox',options:{width:100}}})
 * AccessEdit值：dg.datagrid("getEditorValue",0)
 * SettingsEdit值:dg.datagrid("setEditorValue",{index:0,vlaue:{name:'123',id:780}})
 *
 */
$.extend($.fn.datagrid.methods,
    {
